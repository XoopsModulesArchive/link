...
$filename = 'cache/xhnewbb.js'; //File to read/write
...
ORDER BY topic_time DESC';
    ...
    if (!$result) {
        ...
        while (false !== ($myrow = $xoopsDB->fetchArray($result))) {
            ...
            $temp .= "document.write('<li><span class=\"rss_body\"><A HREF=\"" . XOOPS_URL . '/modules/xhnewbb/viewtopic.php?topic_id=' . $myrow['topic_id'] . '&forum=' . $myrow['forum_id'] . '" target="_blank">';
